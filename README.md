...
ExtensibleDataPipeline pulls data from one place (a data source) and pushes it to another places (targets).

![Imgur](https://i.imgur.com/yJM83Th.png)

You can create as many data source providers and target providers as you want. ExtensibleDataPipeline will import them via **Managed Extensibility Framework**.
